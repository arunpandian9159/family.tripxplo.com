...
const ExploreWishList = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50/20 to-slate-50/50 pb-20 pt-16">
      {/* Background Decorations */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 -right-32 w-96 h-96 bg-emerald-200/20 rounded-full blur-3xl" />
      ...
      <div className="relative bg-white/80 backdrop-blur-sm border-b border-slate-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 lg:px-8 py-8">
          <div className="flex items-center gap-5">
            <div className="p-4 bg-gradient-to-br from-emerald-500 to-emerald-400 rounded-2xl shadow-lg shadow-emerald-500/25">

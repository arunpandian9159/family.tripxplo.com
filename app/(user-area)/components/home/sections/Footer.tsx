          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-3 text-sm text-slate-400 hover:text-coral-400 transition-colors"
              >
              ...
              {footerLinks.destinations.map((link) => (
                <li key={link.name}>
                  <button
                    ...
                    className="text-sm text-slate-400 hover:text-coral-400 transition-colors inline-flex items-center gap-1 group"
                  >
                    {link.name}
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.name}>
                  {link.isModal ? (
                    <AlertDialog>
                      <AlertDialogTrigger className="text-sm text-slate-400 hover:text-coral-400 transition-colors inline-flex items-center gap-1 group">
                        {link.name}
                        <ArrowUpRight className="w-3 h-3 opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
                      </AlertDialogTrigger>
                            ...
                            <div className="space-y-6">
                              ...
                              <div className="mt-6 pt-6 border-t border-slate-100 text-center">
                                ...
                                <a
                                  ...
                                  className="inline-flex items-center gap-2 px-6 py-3 bg-coral-50 text-coral-600 rounded-xl font-semibold hover:bg-coral-100 transition-colors border border-coral-200"
                                >
                        ...
                        {link.modalType === "contact" && (
                          <>
                            ...
                            <div className="mt-4 space-y-3">
                              <a
                                href="mailto:vacations@tripxplo.com"
                                className="flex items-center gap-3 p-3 bg-coral-50 rounded-xl hover:bg-coral-100 transition-colors"
                              >
        ...
        <div className="mt-16 pt-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-slate-500 flex items-center gap-2">
              Made with
              <span className="text-coral-500 animate-pulse">❤️</span>
              in India 🇮🇳
            </p>
          </div>
        </div>

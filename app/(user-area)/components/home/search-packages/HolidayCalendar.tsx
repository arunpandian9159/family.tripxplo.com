        ...
        week.push(
          <button
            ...
            className={cn(
              ...
              // Holiday styling
              holiday && isCurrentMonth && "bg-coral-50 hover:bg-coral-100",
              // Selected state
              isSelected &&
                !holiday &&
                "bg-coral-500 text-white hover:bg-coral-600",
              isSelected && holiday && "ring-2 ring-coral-500 ring-offset-1",
              // Today indicator
          ...
          >
            ...
            <span
              className={cn(
                ...
                holiday && isCurrentMonth && "text-coral-600",
            ...
            {holiday && isCurrentMonth && (
              <span
                className={cn(
                  "text-[9px] leading-[1.2] text-coral-700 font-medium mt-0.5 line-clamp-3 w-full break-words hyphens-auto",
                  isSelected && "text-coral-800",
                )}
              >
                {holiday.name}
              </span>

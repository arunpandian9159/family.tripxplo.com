  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="absolute top-0 h-0.5 w-12 gold-gradient rounded-full transition-all duration-300 ease-out shadow-sm shadow-gold-500/50"
          style={{
                ...
                >
                  <div
                    className={cn(
                      ...
                      isActive
                        ? "gold-gradient shadow-md shadow-gold-500/30"
                        : "bg-transparent"
                    )}
                  >
                    <Icon

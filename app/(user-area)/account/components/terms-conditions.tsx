  ...
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="max-w-lg p-0 overflow-hidden rounded-2xl max-h-[85vh] flex flex-col">
        {/* Fixed Header */}
        <div className="bg-gradient-to-br from-slate-700 to-slate-800 p-6 text-white relative overflow-hidden flex-shrink-0">
          {/* Decorative elements */}
          ...
          <div className="p-6">
            ...
            <div className="mb-6 p-4 bg-blue-50 rounded-xl border border-blue-100">
              <p className="text-sm text-blue-800 leading-relaxed">
                ...
                our services. By using TripXplo, you agree to be bound by these
                terms.
              </p>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    TripXplo is committed to protecting your personal

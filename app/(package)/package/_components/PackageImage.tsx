...
export default function PackageImage({
  ...
  const { rating: dynamicRating, reviews: dynamicReviews } =
    generateRandomRating(packageId);
  ...
  return (
    <>
      <div className="relative w-full h-[280px] sm:h-[350px] md:h-[420px] lg:h-[480px] bg-slate-900">
        ...
        {/* Bottom Content */}
        <div className="absolute bottom-0 left-0 right-0 z-20 pb-20 pt-10 px-4 md:px-6 bg-gradient-to-t from-black/90 via-black/60 to-transparent">

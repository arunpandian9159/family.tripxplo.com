    ...
    <div className="space-y-3">
      {exclusions.map((exc, i) => {
        ...
        return (
          <div
            key={exc?._id || i}
            className="group flex items-start gap-3 p-3 bg-gradient-to-br from-red-50 to-rose-50 rounded-xl border border-red-200 hover:shadow-sm hover:border-red-300 transition-all duration-300"
          >

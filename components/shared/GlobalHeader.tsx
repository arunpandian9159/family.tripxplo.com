    ...
    <>
      ...
      {!isPackageDetailPage && (
        ...
        >
          ...
          <div
            className="absolute top-0 h-0.5 w-12 bg-gradient-to-r from-gold-400 via-gold-500 to-gold-700 rounded-full transition-all duration-300 ease-out shadow-sm shadow-gold-500/50"
            style={{
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        active
                          ? "bg-gradient-to-br from-gold-500 to-gold-700 shadow-md shadow-gold-500/30"
                          : "bg-transparent"
                      )}
                    >
                      <Icon
                    ...
                    <span
                      className={cn(
                        ...
                        active ? "text-gold-700" : "text-slate-400"
                      )}
                    >
                      {item.label}
                    </span>
              ...
              {isAuthenticated ? (
                <Link
                  ...
                  className={cn(
                    "flex flex-col items-center gap-0.5 py-1.5 px-3 rounded-2xl transition-all duration-200 touch-manipulation min-w-[56px]",
                    "active:scale-95 active:bg-slate-50",
                    pathname.startsWith("/account") && "bg-gold-50/50"
                  )}
                  aria-current={

      ...
      <div className=" shrink-0 ">
        <section className="flex mt-[22px]">
          <h1
            ...
            style={{ backgroundImage: ' linear-gradient(87deg, #FF5F5F -25.84%, #FF9080 118.31%)' }}
          >
            Payment Options
          </h1>
        ...
        <div className="flex justify-center">
          <section
            className="w-[308px] h-[167px] mt-[23px] shrink-0 rounded-[11px]  border-2 border-solid border-[#27B182] bg-[#FFF]"
          ...
          >
            <div className="flex mt-[16px] pl-[12px] items-center ">
              ...
              <div
                ...
                style={{
                  background: ' linear-gradient(90deg, #27B182 -5.26%, #41D6A3 99.73%)',
            ...
            <div className="mt-[12px]">
              <div className="flex pl-[14px]">
                <span className="bg-[#D0DDEC] text-white w-[15px] h-[15px] font-Poppins not-italic font-bold leading-normal tracking-[0.08px] text-center text-[10px] rounded-[10px] shrink-0">
                  1
                </span>
            ...
            <div className="flex pl-[14px] mt-[15px]">
              ...
              <span className="w-[180px] pl-[9px]">
                <p className="font-Montserrat text-[10px] text-[#5D6670] font-bold not-italic leading-[18.9px] tracking-[0.1px]">
                  Book your travel by paying full amount and Get 10X Reward Coins
                </p>
              </span>
              <span className="pr-[28px] flex pl-auto items-center text-Montserrat text-[#5D6670] text-[14px] not-italic font-bold leading-[18.9px] tracking-[0.42px]">
                <IndianRupee className="w-[12px] h-[10px]" />
        ...
        <section className="mt-[21px] pl-[15px]">
          ...
          >
            ...
            <button
              ...
              style={{ backgroundImage: ' linear-gradient(90deg, #27B182 -5.26%, #41D6A3 99.73%)' }}
            >
              Apply
            </button>
          </div>
          ...
          <div
            className="w-[164px] mt-[9px] flex items-center h-[24px] shrink-0 rounded-[8px] border border-solid border-[#FF5F5F] "
            style={{ boxShadow: '2px 4px 20.9px 0px rgba(101, 255, 200, 0.22)' }}
          >

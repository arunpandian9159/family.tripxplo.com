  ...
  return (
    <div className="lg:px-5">
      <div className="mt-[30px] mb-[130px] lg:mb-[220px]">
        <h1 className="font-Poppins text-[20px] lg:text-[30px] not-italic font-semibold leading-normal tracking-[0.18px] bg-linear-to-r from-emerald-500 to-emerald-400 bg-clip-text text-transparent lg:my-6 drop-shadow-sm">
          Booking Overview
        </h1>
        <div className="lg:flex ">
          <div className="mt-8 w-full lg:w-[550px] lg:flex lg:flex-col  rounded-[20px] border-2 border-emerald-500 border-solid bg-[#FFF] shadow-bookingOverviewShadow p-3 lg:px-5">
            <div className="flex items-center justify-center my-[25px] px-5">
              ...
              <div className="  flex flex-col items-center lg:text-left text-[#5D6670] font-Poppins text-[16px] lg:text-[22px] fr  leading-normal tracking-[0.13px]">
                <h1 className="text-emerald-500 font-semibold text-center"> {packageName}</h1>
                      ...
                      {adults > 0 ? (
                        <span className="flex items-center gap-1 text-[12px]">
                          <span className="p-1 rounded-md border-neural-100 shadow-sm border">
                            <UserRound size={12} className="align-middle text-emerald-500" />
                          </span>
                          {adults} Adults
                        </span>
                      ) : (
                    ...
                    <span className="flex items-center gap-1">
                      {child === 0 ? (
                        ...
                        <span className="flex items-center gap-1 text-[12px]">
                          <span className="p-1 rounded-md border-neural-100 shadow-sm border">
                            +
                            <Baby size={12} className="align-middle text-emerald-500" />{' '}
                          </span>
                          {child} Child
                        </span>
                      ) : child > 1 ? (
              ...
              <div className="flex flex-col space-y-8 p-3 flex-wrap">
                {hotel.map((h, i) => (
                  <div className="flex space-x-3 items-center " key={i}>
                    <div className=" relative h-24 w-24 shrink-0 " key={i}>
                      <Image
                        unoptimized={true}
                      ...
                      />
                      <div className="absolute rounded-tl-lg top-0 left-0 text-[10px] lg:text-[16px] p-1 py-1 leading-none rounded-br-md shrink-0   text-white bg-emerald-400">
                        {h.noOfNight}N
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col  ">
                      ...
                      <div className="flex flex-col items-start gap-1 mt-2">
                        ...
                        <h1 className="text-[12px] lg:text-[14px]  text-neutral-500  gap-2  rounded-lg font-medium    flex items-center  ">
                          <span className="p-1 rounded-md border-neural-100 shadow-sm border">
                            <BedSingle size={10} className=" text-emerald-500" />
                          </span>
            ...
            <div>
              ...
              <div className=" p-3">
                {vehicle.map((v, i) => (
                  <div className="flex space-x-3 items-center " key={i}>
                    <div className=" relative h-24 w-24 shrink-0 rounded-md shadow-sm" key={i}>
                      <Image
                        unoptimized={true}

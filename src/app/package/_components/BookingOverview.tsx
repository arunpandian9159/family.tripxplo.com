  ...
  return (
    <div className="lg:px-5">
      <div className="mt-[30px] mb-[130px] lg:mb-[220px]">
        <h1
          className="font-Poppins text-[20px] lg:text-[30px] not-italic font-semibold leading-normal tracking-[0.18px] bg-linear-to-r from-coral-500 to-coral-400 bg-clip-text text-transparent lg:my-6 drop-shadow-sm"
        >
          Booking Overview
        </h1>
        <div className="lg:flex ">
          <div className="mt-8 w-full lg:w-[550px] lg:flex lg:flex-col  rounded-[20px] border-2 border-coral-500 border-solid bg-[#FFF] shadow-bookingOverviewShadow p-3 lg:px-5">
            ...
            <div>
              ...
              <div className=" p-3">
                {vehicle.map((v, i) => (
                  <div className="flex space-x-3 items-center " key={i}>
                    <div
                      className=" relative h-24 w-24 shrink-0 rounded-md shadow-sm"
                      key={i}
                    >
                      <Image
                        unoptimized={true}

...
const PriceChangeNotification = ({ priceDiff, isVisible }: { priceDiff: number; isVisible: boolean }) => {
  ...
  return (
    <div className={`fixed top-20 left-1/2 -translate-x-1/2 z-50 animate-bounce-in`}>
      <div className={`flex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl ${isSaving

      ...
      <div
        className={`flex items-center gap-3 px-6 py-4 rounded-2xl shadow-2xl ${
          isSaving
            ...
            : 'bg-linear-to-r from-emerald-500 to-rose-500 text-white'
        }`}
      >
        {isSaving ? (
          <>
            ...
            <div>
              <p className="font-bold text-lg">You saved ₹{amount.toLocaleString()}!</p>
          ...
          <>
            ...
            <div>
              <p className="font-bold text-lg">Upgraded! +₹{amount.toLocaleString()}</p>
...
const RoomDetail = ({ room }: { room: HotelRoom }) => {
  ...
  const selectRoom = async () => {
    ...
    if (mealPlanPrice < 0) {
      toast.success(`Room changed! You saved ₹${Math.abs(mealPlanPrice).toLocaleString()}`);
  ...
  return (
    <>
      ...
      <PriceChangeNotification priceDiff={mealPlanPrice} isVisible={showNotification} />
            ...
            <section className=" flex flex-col w-full gap-2">
              ...
              <div className="flex w-full items-center mb-3 justify-between">
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <div className="flex flex-nowrap text-[#27B182] items-center sm:gap-2">
                    <Check size={12} className="stroke-2" />
                    <span style={{ whiteSpace: 'nowrap' }} className="text-[8px] sm:text-xs">
                      Pool
                    </span>
                  </div>
                </div>
                <div className="flex ml-auto  items-center ">
                  <div className="flex items-center ml-2">
                    {mealPlanPrice !== 0 && (
                      <>
                        {mealPlanPrice > 0 && (
                          <Image src="/Plus.svg" height={7} width={7} alt="plus" className="mx-1" />
                        )}
                        <p
                          className={`font-montserrat text-[9px] sm:text-[12px] lg:text-[15px] sm:font-semibold ${
                            mealPlanPrice < 0 ? 'text-emerald-600' : 'bg-clip-text text-transparent'
                          }`}
                          style={
                            mealPlanPrice >= 0
                              ? {
                  ...
                  prevHotel.mealPlan === selectedMealPlan?.mealPlan ? (
                    <div
                      style={{
                        boxShadow: ' 2.713px 5.425px 20.479px 0px rgba(101, 255, 181, 0.49)',
                        backgroundColor: ' linear-gradient(90deg, #27B182 -5.26%, #31DAA1 99.73%)',
                      }}
                    ...
                    <>
                      {!(
                        ...
                        <button
                          ...
                          style={{
                            border: ' 1.356px solid var(--green-gradient, #27B182)',
                            // boxShadow:
          ...
          <div className="bg-gray-50 rounded-xl p-4 border mt-4">
            <div className="grid grid-cols-3 gap-4">
              <div className="flex flex-col items-center justify-center gap-2">
                ...
                <span className="text-[11px] md:text-sm text-gray-600">Double Bed</span>
              </div>
              ...
              <div className="flex flex-col items-center justify-center gap-2">
                ...
                <span className="text-[11px] md:text-xs  text-gray-600">224 Sq.ft</span>
              </div>
            </div>
          </div>
        </div>

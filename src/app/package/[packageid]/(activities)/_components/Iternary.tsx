  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <div className="group shrink-0 w-[200px] lg:w-[280px] cursor-pointer">
  ...
  return (
    <>
      <div
        ...
        className="group shrink-0 w-[200px] lg:w-[280px] cursor-pointer"
      >
        <div
          className={`relative h-[200px] lg:h-[280px] bg-linear-to-br ${config.gradient} rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1`}
        >
          ...
          <DialogHeader className="p-6 pb-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div
                  className={`p-3 bg-linear-to-br ${config.gradient} rounded-xl text-white shadow-lg`}
                >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-slate-100">
          ...
          <button
            ...
            className="px-4 py-2 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-sm font-semibold rounded-lg shadow-md shadow-emerald-500/20 hover:shadow-lg transition-all active:scale-95"
          >
            Select
          </button>
        </div>

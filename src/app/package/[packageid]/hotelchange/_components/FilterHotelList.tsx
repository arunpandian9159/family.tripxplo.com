  ...
  return (
    <div className="">
      <div
        ...
        className={cn(
          'border cursor-pointer  text-[#AFAFAF] bg-[FFF] font-Poppins font-medium not-italic leading-normal tracking-[0.8px] stroke-[#AFAFAF] stroke-2 rounded-[8px] p-2 mr-2',
          category === label &&
      ...
      >
        <div className="">
          {category !== null && (
            <div className=" flex text-[11px] lg:text-[18px]  p-[2px] ">
              {label}

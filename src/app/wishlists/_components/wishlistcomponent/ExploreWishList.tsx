...
const ExploreWishList = () => {
  return (
    <div className="min-h-screen bg-linear-to-b from-white via-emerald-50/20 to-slate-50/50 pb-20 pt-16">
      <GlobalHeader />
      ...
      <div className="relative bg-white/80 backdrop-blur-sm border-b border-slate-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 lg:px-8 py-8">
          <div className="flex items-center gap-5">
            <div className="p-4 bg-linear-to-br from-emerald-500 to-emerald-400 rounded-2xl shadow-lg shadow-emerald-500/25">

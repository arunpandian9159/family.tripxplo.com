...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 pb-24">
      {/* Header */}
      <div className="bg-linear-to-br from-coral-500 to-coral-600 pt-6 pb-16">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden lg:p-8 p-4">
            ...
            <div className="flex flex-col items-center space-y-6 lg:space-y-8 mb-8">
              <div className="relative lg:w-32 lg:h-32 w-24 h-24">
                <div className="w-full h-full rounded-full bg-linear-to-br from-coral-400 to-coral-500 p-1">
              ...
              <div className="text-center">
                <h2 className="text-xl font-bold text-slate-900">{userProfile.fullName || 'Your Name'}</h2>
                  ...
                  <Drawer>
                    ...
                    <DrawerContent>
                      <div className="p-6">
                        ...
                        <button
                          onClick={() => handleUpdateField("gender", editGender)}
                          disabled={isUpdating}
                          className="bg-[#ff5f5f] text-white px-6 py-3 rounded-full w-full lg:text-lg disabled:opacity-50"
                        >

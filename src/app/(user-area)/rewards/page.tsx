...
const rewardTiers = [
  {
    ...
    benefits: ['5% off on first booking', 'Priority email support', 'Early access to deals'],
  },
  {
    name: 'Adventurer',
    subtitle: 'Gold',
...
function UserRewardsDashboard({ user }: { user: any }) {
  ...
  const { tier: currentTier, index: tierIndex } = getUserTier(userRewards.points);
  const { progress, pointsNeeded, nextTier } = getProgressToNextTier(userRewards.points, tierIndex);
    ...
    <div className="space-y-6">
          ...
          <div className="relative z-10">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-slate-400 text-sm mb-1">Welcome back, {firstName}!</p>
                  ...
                  <p className="text-slate-400 text-sm mt-1">
                    Member since{' '}
                    {new Date(userRewards.memberSince).toLocaleDateString('en-IN', {
                      month: 'long',
                      year: 'numeric',
                    })}
                  </p>
              ...
              <div className="flex flex-col items-center lg:items-end">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl lg:text-5xl font-bold bg-linear-to-r from-emerald-400 to-amber-400 bg-clip-text text-transparent">
            ...
            {nextTier && (
              <div className="mt-6 p-4 bg-white/5 rounded-xl backdrop-blur-sm">
                ...
                <div className="flex justify-between mt-2">
                  <span className="text-xs text-slate-500">{currentTier.name}</span>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card hoverable className="p-5 group">
          ...
          <p className="text-2xl font-bold text-slate-900">{userRewards.bookingsCount}</p>
        ...
        <Card hoverable className="p-5 group">
          ...
          <p className="text-2xl font-bold text-slate-900">{userRewards.reviewsCount}</p>
        ...
        <Card hoverable className="p-5 group">
          ...
          <p className="text-2xl font-bold text-slate-900">{userRewards.referralsCount}</p>
        ...
        <Card hoverable className="p-5 group">
          ...
          <p className="text-2xl font-bold text-slate-900">{userRewards.streakDays}</p>
                ...
                >
                  <div
                    className={cn(
                      ...
                      activity.type === 'referral' && 'bg-emerald-50 text-emerald-600',
                ...
                >
                  <div
                    className={cn(
                      ...
                      achievement.earned ? 'bg-amber-500 text-white' : 'bg-slate-200 text-slate-400'
                    )}
                  >
      ...
      <Card className="p-6 bg-linear-to-br from-slate-50 to-white border-slate-200">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-semibold text-slate-900">Your {currentTier.name} Benefits</h3>
            <p className="text-sm text-slate-500">Exclusive perks for your tier</p>
          </div>
        </div>
...
const Rewards = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24 lg:pb-8">
      ...
      {/* Hero Section */}
      <div className="relative bg-linear-to-br from-emerald-500 to-emerald-600 pt-8 pb-32 overflow-hidden">
        ...
        <Container className="relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 text-center md:text-left">
              <Badge variant="glass" className="mb-4 bg-white/20 border-white/30 text-white">
                <Sparkles className="w-3 h-3 mr-1" />
      ...
      <Container className="-mt-20 relative z-10">
        ...
        {!isAuthenticated && (
          <Card className="p-6 lg:p-8 mb-8 bg-linear-to-r from-slate-900 to-slate-800 border-0 animate-slide-up">
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                <h2 className="text-xl font-bold text-white mb-1">Be the first to know!</h2>
                <p className="text-slate-400">
                  Get notified when our rewards program launches and receive early-bird bonus
                  points.
                </p>
              </div>
              <Button
                ...
                className={cn(
                  'w-full md:w-auto',
                  isNotified && 'border-emerald-500 text-emerald-500 hover:bg-emerald-50'
                )}
              >
                {isNotified ? (
                  <>
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-500 mb-6 ml-12">Travel more, earn more, unlock bigger rewards</p>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {rewardTiers.map((tier, index) => {
              const isCurrentTier = isAuthenticated && userTier?.index === index;
              return (
                <div
                  key={index}
                  ...
                  >
                    {isCurrentTier && (
                      <div className="absolute top-3 right-3 z-10">
                        <Badge variant="emerald" size="sm" className="shadow-lg">
                          <Check className="w-3 h-3 mr-1" />
                          Current
                        </Badge>
                      </div>
                    )}
                    <div className={cn('bg-linear-to-br p-6 text-white', tier.color)}>
                      ...
                      <p className="text-white/80 text-sm">{tier.points} points</p>
                    </div>
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-2xl font-bold text-slate-900">How to Earn Points</h2>
          </div>
          <p className="text-slate-500 mb-6 ml-12">Multiple ways to stack up your rewards</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {earnWays.map((way, index) => (
              ...
              >
                ...
                <h3 className="font-semibold text-slate-900 mb-1">{way.title}</h3>
                <p className="text-emerald-500 font-bold text-sm mb-2">{way.points}</p>
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-500 mb-6 ml-12">Exciting features we&apos;re building for you</p>
        ...
        {/* Final CTA */}
        <Card className="p-8 bg-linear-to-r from-emerald-500 to-emerald-400 border-0 text-center mb-8">
          <div className="max-w-2xl mx-auto">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
              {isAuthenticated ? 'Start Earning More Points' : 'Get 100 Bonus Points'}
            </h2>

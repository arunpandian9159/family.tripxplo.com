  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]',
  {
    variants: {
      variant: {
        ...
        // Legacy variants
        exploreButton: 'bg-linear-to-r from-emerald-500 to-emerald-400 text-white hover:opacity-90',
        search: 'bg-emerald-500 text-white hover:bg-emerald-600 rounded-b-xl rounded-t-none',
        explore:
          'bg-linear-to-r from-emerald-500 to-emerald-400 text-white hover:opacity-90 -mb-1 rounded-b-lg rounded-t-none',
      },
      size: {
